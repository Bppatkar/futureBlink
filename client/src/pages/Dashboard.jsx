...
import { Moon, Sun, History, Zap, Cpu, Activity } from 'lucide-react';
      ...
      <div className="w-full h-[calc(100vh-84px)] p-4">
          ...
          <div className="fixed inset-0 z-50 flex items-start justify-end pt-16">
            ...
            <div className={`relative w-96 h-[calc(100vh-64px)] mr-4 rounded-2xl shadow-2xl animate-slide-in ${
              ...
              <div className="p-6 border-b border-white/10">
                ...
                <p className="text-sm opacity-70 mt-1">Your previous conversations</p>
              </div>
              <div className="p-4 overflow-y-auto h-[calc(100%-120px)]">
                {loadingHistory ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-64 text-center">
                    ...
                    <p className="opacity-70">No history yet</p>
                    <p className="text-sm opacity-50 mt-1">Start a conversation to see history</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {history.map((item, index) => (
                      <div 
                        key={index} 
                        className={`p-4 rounded-xl transition-all-300 hover:scale-[1.02] ${
                          darkMode 
                      ...
                      >
                        ...
                        <div className="text-sm opacity-70 line-clamp-2">{item.response}</div>
        ...
        <div className={`w-full h-full rounded-2xl overflow-hidden ${
          darkMode 
            ...
            : 'bg-white/90'
        } backdrop-blur-sm shadow-2xl border border-white/10`}>
